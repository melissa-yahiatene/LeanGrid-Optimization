...
public class TestSauvegardeTGinstance1 {
    public static void main(String[] args) throws IOException {
        // Générateurs
        Generateur gen1 = new Generateur("gen1", 70);
        Generateur gen2 = new Generateur("gen2", 35);
        Generateur gen3 = new Generateur("gen3", 40);
        Generateur gen4 = new Generateur("gen4", 62);
        Generateur gen5 = new Generateur("gen5", 42);
        Generateur gen6 = new Generateur("gen6", 83);
        Generateur gen7 = new Generateur("gen7", 15);
        Generateur gen8 = new Generateur("gen8", 50);
        Generateur gen9 = new Generateur("gen9", 50);
        ...
        listeGen.add(gen4); listeGen.add(gen5); listeGen.add(gen6);
        listeGen.add(gen7); listeGen.add(gen8); listeGen.add(gen9);
        ...
        File f = new File("ExportedFiles" + File.separator+ "testSauvegardeTGinstance1.txt");
